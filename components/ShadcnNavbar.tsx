...
//                   <a
//                     className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-slate-200/50 to-slate-200 p-6 no-underline outline-none focus:shadow-md"
//                     href="/"
//                   >
